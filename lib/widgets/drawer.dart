          ...
          Expanded(
            child: ListView(
              ...
              children: [
                ...
                ...lists
                    .where((l) => l.name != 'My Day' && l.name != 'My Tasks')
                    .map(
                      (l) => _item(
                        IconData(l.iconCode, fontFamily: 'MaterialIcons'),
                        l.name,
                        Color(l.colorValue),
                        context,
                      ),
  ...
  Widget _item(
    ...
    return Padding(
      ...
      child: ListTile(
        leading: Icon(
          icon,
          color: isSel ? color : theme.colorScheme.onSurfaceVariant,
        ),
        title: Text(
          label,
          style: TextStyle(
        ...
        tileColor: isSel ? color.withValues(alpha: 0.1) : null,
        onTap: () {
