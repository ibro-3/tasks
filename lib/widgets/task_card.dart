...
class TactileTaskCard extends StatefulWidget {
  ...
  @override
  State<TactileTaskCard> createState() => _TactileTaskCardState();
}

class _TactileTaskCardState extends State<TactileTaskCard>
      ...
      child: ScaleTransition(
        ...
        child: AnimatedContainer(
          ...
          margin: EdgeInsets.symmetric(
            horizontal: 16,
            vertical: widget.settings.isCompact ? 2 : 6,
          ),
            ...
            border: Border.all(
              color: widget.isOverdue && !task.isCompleted
                  ...
                  : theme.colorScheme.outlineVariant.withValues(
                      alpha: task.isCompleted ? 0.1 : 0.3,
                    ),
            ),
          ),
          child: Padding(
