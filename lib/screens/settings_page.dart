      ...
      body: ListView(
        children: [
          ...
          SwitchListTile(
            ...
            value: s.isOled,
            onChanged: s.themeMode == ThemeMode.light
                ? null
                : (v) => s.updateOled(v),
          ),
          const Divider(),
          ...
          SwitchListTile(
            ...
            value: s.isCompact,
            onChanged: (v) => s.updateCompact(v),
          ),
          SwitchListTile(
            title: const Text("Sounds"),
            value: s.soundOn,
            onChanged: (v) => s.updateSound(v),
          ),
          const SizedBox(height: 20),
          Padding(
            padding: const EdgeInsets.all(16),
            child: Text(
              "Corner Radius: ${s.radius.toInt()}px",
              style: TextStyle(
                color: Theme.of(context).colorScheme.primary,
                fontWeight: FontWeight.bold,
              ),
          ...
          Slider(
            ...
            min: 0,
            max: 48,
            onChanged: (v) => s.updateCornerRadius(v),
          ),
          const SizedBox(height: 40),
          Center(
            child: Text("v$appVersion", style: TextStyle(color: Colors.grey)),
          ),
        ],
      ),
    );
            ...
            child: ClipRRect(
              ...
              child: Stack(
                children: [
                  ...
                  // Selection Tint
                  if (isSelected)
                    Container(color: scheme.primary.withValues(alpha: 0.1)),
                ],
              ),
            ),
          ),
